...
NMSettingActions *         nm_connection_get_setting_actions           (NMConnection *connection);
...
NMSettingResources *       nm_connection_get_setting_resources         (NMConnection *connection);
